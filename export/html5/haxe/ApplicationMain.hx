...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("fnf offset helper", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("fnf offset helper", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "fnf offset helper";
		app.meta["name"] = "fnf offset helper";
		...
		#elseif !air
		app.window.context.attributes.background = 12763842;
